...
const App = () => (
    <Router>
        <div>
            ...
            <Link to="ajaxGlobal">Ajax(Global)</Link>{'　'}
            <Link to="ajaxLocal">Ajax(Local)</Link>
            <Switch>
                ...
                <Route path="/ajaxGlobal" component={AjaxGlobal} />
                <Route path="/ajaxLocal" component={AjaxLocal} />
...
class AjaxGlobal extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            "content": "default"
    ...
    render() {
        return(
            (
                ...
                : 
                <h2>Ajax Not Mounted</h2>
            )
        )
    }
}

class AjaxLocal extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            "content": "default"
